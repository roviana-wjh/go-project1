...
// Validate checks the field values on AppealListItem with the rules defined in
// the proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *AppealListItem) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on AppealListItem with the rules defined
// in the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in AppealListItemMultiError,
// or nil if none found.
func (m *AppealListItem) ValidateAll() error {
	return m.validate(true)
}

func (m *AppealListItem) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return AppealListItemMultiError(errors)
	}

	return nil
}

// AppealListItemMultiError is an error wrapping multiple validation errors
// returned by AppealListItem.ValidateAll() if the designated constraints
// aren't met.
type AppealListItemMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m AppealListItemMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m AppealListItemMultiError) AllErrors() []error { return m }

// AppealListItemValidationError is the validation error returned by
// AppealListItem.Validate if the designated constraints aren't met.
type AppealListItemValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e AppealListItemValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e AppealListItemValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e AppealListItemValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e AppealListItemValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e AppealListItemValidationError) ErrorName() string { return "AppealListItemValidationError" }

// Error satisfies the builtin error interface
func (e AppealListItemValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = AppealListItemValidationError{}
...
func (m *ReplyReviewRequest) validate(all bool) error {
	...
	if utf8.RuneCountInString(m.GetExtJSON()) > 8192 {
		err := ReplyReviewRequestValidationError{
			field:  "ExtJSON",
			reason: "value length must be at most 8192 runes",
		}
	...
	if utf8.RuneCountInString(m.GetCtrlJSON()) > 8192 {
		err := ReplyReviewRequestValidationError{
			field:  "CtrlJSON",
			reason: "value length must be at most 8192 runes",
		}
...
// Validate checks the field values on ListReviewByUseIdRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *ListReviewByUseIdRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on ListReviewByUseIdRequest with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// ListReviewByUseIdRequestMultiError, or nil if none found.
func (m *ListReviewByUseIdRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *ListReviewByUseIdRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
...
// ListReviewByUseIdRequestMultiError is an error wrapping multiple validation
// errors returned by ListReviewByUseIdRequest.ValidateAll() if the designated
// constraints aren't met.
type ListReviewByUseIdRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m ListReviewByUseIdRequestMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m ListReviewByUseIdRequestMultiError) AllErrors() []error { return m }

// ListReviewByUseIdRequestValidationError is the validation error returned by
// ListReviewByUseIdRequest.Validate if the designated constraints aren't met.
type ListReviewByUseIdRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e ListReviewByUseIdRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e ListReviewByUseIdRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e ListReviewByUseIdRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e ListReviewByUseIdRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e ListReviewByUseIdRequestValidationError) ErrorName() string {
	return "ListReviewByUseIdRequestValidationError"
}

// Error satisfies the builtin error interface
func (e ListReviewByUseIdRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sListReviewByUseIdRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = ListReviewByUseIdRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = ListReviewByUseIdRequestValidationError{}
