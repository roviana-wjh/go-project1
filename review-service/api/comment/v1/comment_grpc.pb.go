...
const (
	...
	CommentService_UpdateComment_FullMethodName = "/api.comment.v1.CommentService/UpdateComment"
	CommentService_DeleteComment_FullMethodName = "/api.comment.v1.CommentService/DeleteComment"
	CommentService_GetComment_FullMethodName    = "/api.comment.v1.CommentService/GetComment"
	CommentService_ListComments_FullMethodName  = "/api.comment.v1.CommentService/ListComments"
)
...
func (c *commentServiceClient) ListComments(ctx context.Context, in *ListCommentsRequest, opts ...grpc.CallOption) (*ListCommentsReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
