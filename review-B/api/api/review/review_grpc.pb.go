...
func (c *reviewClient) ListReviewByUseId(ctx context.Context, in *ListReviewByUseIdRequest, opts ...grpc.CallOption) (*ListReviewReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListReviewReply)
	err := c.cc.Invoke(ctx, Review_ListReviewByUseId_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedReviewServer) ListReviewByUseId(context.Context, *ListReviewByUseIdRequest) (*ListReviewReply, error) {
	return nil, status.Error(codes.Unimplemented, "method ListReviewByUseId not implemented")
}
...
func _Review_ListReviewByUseId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListReviewByUseIdRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ReviewServer).ListReviewByUseId(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Review_ListReviewByUseId_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReviewServer).ListReviewByUseId(ctx, req.(*ListReviewByUseIdRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Review_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ListReviewByUseId",
			Handler:    _Review_ListReviewByUseId_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "api/review/review.proto",
}
