...
type Data struct {
	...
	Review        *Data_Review           `protobuf:"bytes,3,opt,name=review,proto3" json:"review,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Data) GetReview() *Data_Review {
	if x != nil {
		return x.Review
	}
	return nil
...
// review-service：优先 Consul（registry + service）；否则直连 endpoint
type Data_Review struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *Data_Review) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Data_Review) ProtoMessage() {}

func (x *Data_Review) ProtoReflect() protoreflect.Message {
	mi := &file_conf_conf_proto_msgTypes[8]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Data_Review.ProtoReflect.Descriptor instead.
func (*Data_Review) Descriptor() ([]byte, []int) {
	return file_conf_conf_proto_rawDescGZIP(), []int{2, 2}
}

func (x *Data_Review) GetService() string {
	if x != nil {
		return x.Service
	}
	return ""
...
func (x *Data_Review) GetEndpoint() string {
	if x != nil {
		return x.Endpoint
	}
	return ""
...
const file_conf_conf_proto_rawDesc = "" +
	...
	"\anetwork\x18\x01 \x01(\tR\anetwork\x12\x12\n" +
	"\x04addr\x18\x02 \x01(\tR\x04addr\x123\n" +
	"\atimeout\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\atimeout\"\xce\x03\n" +
	"\x04Data\x125\n" +
	"\bdatabase\x18\x01 \x01(\v2\x19.kratos.api.Data.DatabaseR\bdatabase\x12,\n" +
	"\x05redis\x18\x02 \x01(\v2\x16.kratos.api.Data.RedisR\x05redis\x12/\n" +
	"\x06review\x18\x03 \x01(\v2\x17.kratos.api.Data.ReviewR\x06review\x1a:\n" +
	"\bDatabase\x12\x16\n" +
...
var file_conf_conf_proto_goTypes = []any{
	...
	(*Data_Review)(nil),         // 8: kratos.api.Data.Review
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	8,  // 7: kratos.api.Data.review:type_name -> kratos.api.Data.Review
